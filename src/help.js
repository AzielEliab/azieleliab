...
export function helpTxt() {
  return [
    ...
    "## Why (published work)",
    "",
    "The world prefers a finished object. I keep looking. The work is how I stay in contact with what does not need me.",
    "Machine Why: " + CANON_ORIGIN + "/who-is · " + CANON_ORIGIN + "/llms.txt · " + CANON_ORIGIN + "/cite.json",
    "Visible Why page: " + CANON_ORIGIN + "/why",
    "",
