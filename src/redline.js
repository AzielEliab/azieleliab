...
export const PUBLIC_DOORS = Object.freeze([
  ...
  { method: "GET", path: "/count", role: "read", auth: "none", note: "Nodes#/LiveNodes# + site_live_nodes" },
  { method: "GET", path: "/v1/count", role: "read", auth: "none", note: "same as /count" },
  { method: "POST", path: "/heartbeat", role: "mutate", auth: "none", note: "human page-viewer presence" },
  { method: "POST", path: "/v1/heartbeat", role: "mutate", auth: "none", note: "same as /heartbeat" },
