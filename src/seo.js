...
export function llmsTxt(software = SOFTWARE) {
  ...
  return [
    ...
    "- Operator enable requires a declared bearer (example: suite-presence). Read-only suite presence is on (display from runtime). Display only. Not Node Gate.",
...
export function aiTxt() {
  ...
  return [
    ...
    "- Operator enable requires a declared bearer (example: suite-presence). Read-only suite presence is on (display from runtime). Display only.",
