...
export function citeDoc(software = SOFTWARE, runtimeVersion = RUNTIME_VERSION, survival = null) {
  ...
  return {
    ...
    spore: banSurvival.spore,
    spore_spec: banSurvival.spore_spec,
    survival_stack: banSurvival.survival_stack,
    re_cold_store: banSurvival.re_cold_store,
    ...
    mesh: CANON_ORIGIN + MESH_PATH,
    mesh_runtime: RUNTIME_LOCAL + MESH_PATH,
    mesh_origin: RUNTIME + MESH_PATH,
...
export function llmsTxt(software = SOFTWARE, survival = null) {
  ...
  return [
    ...
    "- Live Nodes FAQ answer: " + LIVE_NODES_FAQ_ANSWER,
    ...
    "- Mesh: " + RUNTIME_LOCAL + "/v1/mesh (QNM-BUILD-1.0 Live Nodes SoT; " + LIVE_NODES_LLMS + ")",
    "- Mesh status: " + RUNTIME_LOCAL + "/v1/mesh/status (QNM-BUILD-1.0 suite rollup; " + LIVE_NODES_LLMS + ")",
    ...
    "- GET " + CANON_ORIGIN + "/v1/mesh  (QNM-BUILD-1.0 Live Nodes SoT; " + LIVE_NODES_LLMS + "; suite-presence operator enable)",
    "- GET " + CANON_ORIGIN + "/v1/mesh/status  (QNM-BUILD-1.0 suite rollup; " + LIVE_NODES_LLMS + "; suite-presence operator enable)",
    "- GET " + CANON_ORIGIN + "/v1/mesh/nodes",
    "- GET " + CANON_ORIGIN + "/count  (Nodes#/LiveNodes# + site_live_nodes; HDJ excluded)",
...
export function aiTxt(survival = null, software) {
  ...
  return [
    ...
    "- Channel plane wifi/bluetooth/rf/photon ON cites; worker_hardware:false.",
    "- MCP: Softwares via fraggate_call only. FragGate sole door. master_33:false.",
    "- Runtime mesh: " + RUNTIME_LOCAL + "/v1/mesh",
    ...
    "@graph": [
      ...
      },
      {
        ...
        description:
          ...
          "/mcp. Mesh status " +
          RUNTIME_LOCAL +
          "/v1/mesh (QNM-BUILD-1.0 Live Nodes SoT; " +
          LIVE_NODES_LLMS +
          "; suite-presence operator enable). QNS-CD-1.0 photon QNS1 packet transfer cite. Author Aziel Eliab.",
        author: person,
        creator: person,
        isPartOf: { "@id": siteId },
        license: "https://www.apache.org/licenses/LICENSE-2.0",
