...
const SITEMAP_RANK = {
  ...
  [CANON_ORIGIN + "/mission"]: { changefreq: "weekly", priority: "0.8" },
...
export function llmsTxt(software = SOFTWARE) {
  ...
  return [
    ...
    "- Softwares alias: " + SOFTWARE_HREF + " (200 same homepage Software strip; /#software still works for humans)",
    ...
    "",
    "- GET " + CANON_ORIGIN + "/",
    "- GET " + SOFTWARE_HREF + "  (200 same homepage Software strip; /#software still works for humans)",
    "- GET " + CANON_ORIGIN + "/mission  (200 same homepage Mission strip; /#mission still works for humans)",
    "- GET " + CANON_ORIGIN + "/why  (200 same homepage Why strip)",
    "- GET " + CANON_ORIGIN + "/research  (200 same homepage Research strip)",
    "- GET " + CANON_ORIGIN + "/doors  (200 same homepage Doors strip)",
...
export function aiTxt() {
  ...
  return [
    ...
    "- Softwares: " + SOFTWARE_SECTION + " (alias " + SOFTWARE_HREF + " 200 same HTML)",
